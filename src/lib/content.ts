...
export interface AboutData {
  ...
  cta_buttons: {
    contact: { text: string; email: string; icon: string }
    cv: { text: string; file_url: string | string[]; icon: string }
  }
  final_cta: {
    title: string
    ...
    buttons: {
      projects?: { text: string; link: string; icon: string }
      calendly?: { text: string; link: string; icon: string }
      contact: { text: string; email: string; icon: string }
    }
  }
  body: string

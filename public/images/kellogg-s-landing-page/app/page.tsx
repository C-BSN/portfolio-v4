  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 font-sans">
      ...
      <section className="relative h-[70vh] bg-pink-100">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center">
            <h2 className="text-5xl md:text-6xl font-bold text-red-600 mb-4 font-serif">L'Amour au Premier Crunch</h2>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center font-serif">Notre Douce Symphonie</h2>
      ...
      <section className="py-16 bg-red-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-8 font-serif">Trouvez le Ticket d'Or !</h2>
      ...
      <section className="py-16 bg-pink-100">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-8 font-serif">Débloquez du Contenu Exclusif</h2>
          <p className="text-lg mb-8 max-w-2xl mx-auto">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center font-serif">Restez Informé</h2>
